...
// Constructor
bool controller_ctor(struct controller_s *controller, struct skeleton_s *skeleton);
...
void controller_skeleton_set(struct controller_s *controller, struct skeleton_s *skeleton);
...
void controller_fade_to(struct controller_s *controller, struct clip_s *target, float fade_time);
