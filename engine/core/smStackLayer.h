...
void stack_layer_push(struct stack_layer_s *stack_layer, layer_s *layer);
void stack_layer_push_overlay(struct stack_layer_s *stack_layer, layer_s *layer);
...
layer_s *stack_layer_get_layer(struct stack_layer_s *stack_layer, size_t index);
