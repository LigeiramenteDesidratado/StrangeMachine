...
// Constructor
status_v skeleton_ctor(struct skeleton_s *skeleton, pose_s *rest, pose_s *bind, const char **const names);
...
char *skeleton_get_joint_name(const struct skeleton_s *const skeleton,
                              uint32_t index);
