...
const uint32_t sm__tab64[64] = {63, 0,  58, 1,  59, 47, 53, 2,  60, 39, 48, 27, 54, 33, 42, 3,  61, 51, 37, 40, 49, 18,
...
uint32_t sm__log2_64(uint64_t value) {
  ...
  value |= value >> 16;
  value |= value >> 32;
  return sm__tab64[((uint64_t)((value - (value >> 1)) * 0x07EDD5E59A4E28C2)) >> 58];
}
