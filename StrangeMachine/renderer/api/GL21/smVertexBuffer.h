...
b8 GL21vertex_buffer_ctor(struct vertex_buffer_s *vertex_buffer, buffer_desc_s *desc);
...
void GL21vertex_buffer_bind(struct vertex_buffer_s *vertex_buffer, u32 *locations, size_t length);
void GL21vertex_buffer_unbind(struct vertex_buffer_s *vertex_buffer, u32 *locations, size_t length);
